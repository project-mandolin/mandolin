...
import org.mitre.mandolin.glp.{ANNetwork, AbstractProcessor, CategoricalGLPPredictor, GLPFactor, GLPLossGradient, GLPModelReader, MandolinMLPSettings, GLPModelSpec, GLPModelWriter, GLPPosteriorOutputConstructor, GLPWeights}
