...
object SparkModelSelectionDriver {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val builder: MandolinLogisticRegressionModelSpaceBuilder = MandolinLogisticRegressionFactory.getModelSpaceBuilder()
    ...
    new SparkModelSelectionDriver(sc, builder.build(), trainFile, testFile, numWorkers, workerBatchSize, scoreSampleSize, acqFunRelearnSize, totalEvals)
  }
}
