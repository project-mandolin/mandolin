...
class LocalModelSelector(val ms: ModelSpace, trainFile: String, testFile: String, numWorkers: Int, numThreads: Int, workerBatchSize: Int, scoreSampleSize: Int, acqFunRelearnSize: Int, totalEvals: Int) extends ModelSelectionDriver(ms, trainFile, testFile, numWorkers, numThreads, workerBatchSize, scoreSampleSize, acqFunRelearnSize, totalEvals) {
  override val ev = {
